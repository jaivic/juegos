        ...
        $.post(this.sDirAjax, function(o) {
            ...
            if (o.Tupla > 0) {
                for (var i = 0; i < o.Tupla; i++) {
                    ...
                    objMangoTabla.LlenarFila([o.Resultado[i].Nombre, objMangoTabla.CrearBoton("FormGrupo.Eliminar(" + o.Resultado[i].ID + ")", "icon-remove") + objMangoTabla.CrearBoton("FormGrupo.Editar(" + o.Resultado[i].ID + ")", "icon-pencil")]);
                }
                objMangoTabla.CrearTabla();
            }
        }, "json");
    }
