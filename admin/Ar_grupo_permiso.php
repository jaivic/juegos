...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <script src="jsajax/r_permiso_grupo.js"></script>
...
<?php include_once 'frame/menu.php'; ?> 
            ...
            <section id="content" class="container_12 clearfix" data-sort=true>
                ...
                <h1 class="grid_12"> Gestionar permiso de los grupos</h1>

                <form action="javascript:void(0);" class="grid_12">
                    <fieldset>
                        <legend>¿Desea crear un permiso a un grupo?</legend>
                        <div class="row">
                            <label for="sNombre">
                                <strong>Grupo</strong>
                            </label>
                            ...
                            <table id="tabla" class="styled">
                              ...
                              <script type="text/javascript">
                                $().ready(function() {
                                    ...
                                    MangoTabla.CrearColumna("Grupo", 'span="1" style="width: 500px;', "");
