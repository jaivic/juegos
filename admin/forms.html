...
<head>
    ...
    <title>Form Elements - Mango: Slick and Responsive Admin Template</title>
...
<body>
    ...
    <!-- Navigation -->
                    <nav><ul class="collapsible accordion">
                        ...
                        <li class="current">
                            <a class="open" href="javascript:void(0);"><img src="img/icons/packs/fugue/16x16/application-form.png" alt="" height=16 width=16>Form Elements</a>
                            <ul>
                                <li class="current"><a href="forms.html"><span class="icon icon-list-alt"></span>General</a></li>
...
﻿			<h1 class="grid_12">Form Elements</h1>
			...
			<form action="" class="grid_12">
				<fieldset>
					...
					<div class="row">
						<label for="f1_password">
							<strong>Password Field</strong>
							<small>with tooltip</small>
						</label>
						<div>
							<input type="password" class="tooltip" data-gravity=n title="Please use a secure password!" name="f1_password" id="f1_password" />
						</div>
					</div>
					...
					<div class="row">
						...
						<div>
							<input type="text" value="http://" name="f1_value" id="f1_value" />
						</div>
					</div>
					...
					<div class="row">
						...
						<div>
							<textarea class="nogrow" rows=5 name="f1_textarea" id="f1_textarea">&nbsp;</textarea>
						</div>
					</div>
					...
					<div class="row not-on-phone">
						...
						<div>
							<textarea class="editor" name="f1_wysiwyg" id="f1_wysiwyg" ></textarea>
						</div>
					</div>
				...
				<fieldset class="not-on-phone">
					...
					<div class="row">
						...
						<div>
							<select multiple class="dualselects" data-size=small id=f2_double name=f2_double >
				...
				<fieldset>
					...
					<div class="row">
						...
						<div>
							<input type="datetime" name=f3_datepicker id=f3_datepicker value="11/11/1993 15:15" />
						</div>
					</div>
				...
				<fieldset>
					...
					<div class="row">
						...
						<div>
							<div><input type="checkbox" name=f4_cb id=f4_cb /> <label for="f4_cb">Select it?</label></div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div>
							<div><input type="checkbox" disabled name=f4_cb_dis id=f4_cb_dis /><label for="f4_cb_dis">Select it?</label></div>
						</div>
					</div>
				...
				<fieldset>
					...
					<div class="row">
						...
						<div>
							<div><input type="radio" name="f4_rb" id="f4_rb1" value="Mastercard"><label for="f4_rb1">Mastercard</label></div>
							<div><input type="radio" name="f4_rb" id="f4_rb2" value="Visa"><label for="f4_rb2">Visa</label></div>
							<div><input type="radio" name="f4_rb" id="f4_rb3" value="AmericanExpress"><label for="f4_rb3">American Express</label></div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div>
							<div><input type="radio" name="f4_rb_dis" id="f4_rb_dis1" disabled value="Mastercard"><label for="f4_rb_dis1">Mastercard</label></div>
							<div><input type="radio" name="f4_rb_dis" id="f4_rb_dis2" checked disabled value="Visa"><label for="f4_rb_dis2">Visa</label></div>
							<div><input type="radio" name="f4_rb_dis" id="f4_rb_dis3" disabled value="AmericanExpress"><label for="f4_rb_dis3">American Express</label></div>
						</div>
					</div>
				...
				<fieldset>
					...
					<div class="row">
						...
						<div>
							<input type=password class="meter strongpw" name=f6_pw id=f6_pw />
						</div>
					</div>
					<div class="row">
						<label for="f6_spinner">
							<strong>Spinner</strong>
						</label>
						<div>
							<input data-type="spinner" min=-20 max=20 value=1 id=f6_spinner name=f6_spinner />
						</div>
					</div>
					<div class="row not-on-phone">
						<label for="f6_file">
				...
				<fieldset class="not-on-phone">
					...
					<div class="row">
						<label for="f7_dateinline">
							<strong>Inline Datepicker</strong>
						</label>
						<div>
							<div data-type="datetime" data-id=f7_dateinline data-name=f7_dateinline ></div>
						</div>
					</div>
					
					<div class="row">
						<label for="f7_color_flat">
							<strong>Inline-Picker</strong>
							<small>(flat picker)</small>
						</label>
						<div>
							<div>
								<input type="color" class="flat" name=f7_color_flat id=f7_color_flat />
							</div>
						</div>
					</div>
				...
				<form action="" class="box">
					...
					<div class="content">
						...
						<div class="row">
							...
							<div>
								<input class="maskTin" name=f8_mi_tin id=f8_mi_tin type=text />
							</div>
						</div>
						<div class="row">
							...
							<div>
								<input class="maskSsn" name=f8_mi_ssn id=f8_mi_ssn type=text />
							</div>
						</div>
						<div class="row">
						
							<label for="f8_mi_prod">
								<strong>Product Key</strong>
								<small>a*-999-a999</small>
							</label>
							<div>
								<input class="maskProd" name=f8_mi_prod id=f8_mi_prod type=text />
							</div>
						</div>
						...
						<div class="row">
							...
							<div>
								<input class="maskPo" name=f8_mi_po id=f8_mi_po type=text />
							</div>
						</div>
						
						<div class="row">
							<label for="f8_mi_perc">
								<strong>Percent</strong>
								<small>99%</small>
							</label>
							<div>
								<input class="maskPct" name=f8_mi_perc id=f8_mi_perc type=text />
							</div>
						</div>
					</div><!-- End of content -->
			...
			<div class="grid_4">
				<form method="post" action="#" class="box validate">
					...
					<div class="content">
						...
						<p class="_100 small">
							<label for="f9_ban" class=inline >Bank Account Number:</label>
							<input data-error-type=inline type="text" class=required name=f9_ban id=f9_ban pattern="^\d{1,10}$" />
						</p>
						
						<p class="_100 small">
							<label for="f9_name" class=inline >Name:</label>
							<input data-error-type=inline type="text" class=required name=f9_name id=f9_name />
						</p>
						
						<p class="_100 small">
							<label for="f9_pin" class=inline >PIN:</label>
							<input data-error-type=inline type="password" class=required name=f9_pin id=f9_pin />
						</p>
