		     ...
		     <div class="grid_12">
                    ...
                    <div class="box tabbedBox">
                        <div class="header">
                            <h2>Tabs</h2>
                            <ul>
                                <li><a href="#id-1">Primer idioma</a></li>
                                <li><a href="#id-2">Segundo idioma</a></li>
                                <li><a href="#id-3">N Idiomas</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="content tabbed">
                            <div id="id-1">
                                <form action="" class="grid_12">
                                    <fieldset>
                                        <legend>¿Desea crear un Caracteristicas? - primer idioma</legend>
                                        <div class="row">
                                            <label for="sNombre-1">
                                            ...
                                            <div>
                                                <input  id="sNombre-1" type="text" placeholder="Agregue un nombre" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label for="sDescripcion-1">
                                                <strong>Descripcion</strong>
                                                <small>informacion que ayude a explicar el nombre de la Clasificacion</small>
                                            </label>
                                            <div>
                            ...
                            <div id="id-2">
                                 <form action="" class="grid_12">
                                    <fieldset>
                                        <legend>¿Desea crear un Caracteristicas? - segundo idioma</legend>
                                        <div class="row">
                                            <label for="sNombre-2">
                                                <strong>Nombre</strong>
                                            ...
                                            <div>
                                                <input type="text" placeholder="Agrege un nombre" id="sNombre" />
                                            </div>
                                        </div>
                                        <div class="row">
                ...
                <div class="grid_12">
                    <div class="box">
                        ...
                        <div class="header">
                            <h2>Listas de los Caracteristica existentes</h2>
                        </div>
